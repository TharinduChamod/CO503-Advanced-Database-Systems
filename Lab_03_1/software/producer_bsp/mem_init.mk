...
# Memory: data_memory_0
MEM_0 := SoC_data_memory_0
$(MEM_0)_NAME := data_memory_0
...
$(MEM_0)_HIERARCHICAL_PATH := data_memory_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: data_memory_0
data_memory_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: instruction_memory_0
MEM_1 := SoC_instruction_memory_0
$(MEM_1)_NAME := instruction_memory_0
...
$(MEM_1)_HIERARCHICAL_PATH := instruction_memory_0
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: instruction_memory_0
instruction_memory_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: shared_memory
MEM_2 := SoC_shared_memory
