...
void FIFO_1_INIT()
{
	...
	/**
	 *
	 * addressthe base address of the FIFO control slave
	 * ienablethe value to write to the interruptenable register
	 * emptymarkthe value for the almost empty threshold level
	 * fullmarkthe value for the almost full threshold level
	 *
	 * */
