...
//#define CTRL_MEMORY 0x00031060
#define CTRL_MEMORY 0x0000000


#define IN_BASE 0x00031074 		// Base address of the memory device. SET THIS PROPERLY
#define OUT_BASE 0x0003104c 	// Base address of the memory device. SET THIS PROPERLY
